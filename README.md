...
### Install otomatis
```
wget -O mises.sh https://raw.githubusercontent.com/asupangat/mises/main/mises.sh && chmod +x mises.sh && ./mises.sh
```
...
### Delegasi dan Rewards
  * delegasi
```
misestmd tx staking delegate $(misestmd keys show $WALLET --bech val -a) 1000000umis --from $WALLET --chain-id mainnet --fees 250umis
```
  * withdraw reward
```
